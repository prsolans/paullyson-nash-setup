...
?>
    ...
    <div class="post-content">
        ...
        <?php
            ...
            echo '<br/>Service: '. get_field('prs_restaurant_service') . '<br/>';
            echo '<br/>Food: '. get_field('prs_restaurant_food') . '<br/>';
            echo '<br/>Ambiance: '. get_field('prs_restaurant_ambiance') . '';
            echo '</div>';
            echo '<div class="rating-block">Allykc says<br/>';
            echo '<br/>Service: '. get_field('allykc_restaurant_service') . '<br/>';
            echo '<br/>Food: '. get_field('allykc_restaurant_food') . '<br/>';
